    ...
    usersList.innerHTML = state.users.map(user => {
        ...
        <div class="admin-item">
            ...
            <div class="admin-item-actions">
                ...
                `}
                <button onclick="toggleChatAccess('${user._id}', ${!canChat})" class="admin-btn ${canChat ? 'admin-btn-success' : 'admin-btn-warning'}">
                    ${canChat ? '✅ چت فعال' : '⛔ چت غیرفعال'}
                </button>
                ${!isMainAdmin ? `
...
// ============================================
// ADMIN ACTIONS (اصلاح شده با apiCall)
// ============================================
...
// ============================================
// TOGGLE CHAT ACCESS (اصلاح شده با apiCall)
// ============================================
...
// ============================================
// MAKE USER ADMIN (اصلاح شده با apiCall)
// ============================================
...
// ============================================
// DELETE USER (اصلاح شده با apiCall)
// ============================================
